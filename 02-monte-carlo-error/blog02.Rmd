...
We can also generate the results with the y-axis is on the log10 scale. It can be found that the obtained image has a similar decreasing trend to that on the log2 scale.
